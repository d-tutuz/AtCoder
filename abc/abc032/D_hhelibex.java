...
public class D_hhelibex {
	...
	private static class Pair<T extends Comparable<T>> implements
			Comparable<Pair<T>> {
		T a;
		T b;
		...
		public boolean equals(Object o) {
			if (o instanceof Pair) {
				Pair that = (Pair) o;
				boolean res = (this.a == null && this.a == that.a || this.a != null
						&& this.a.equals(that.a));
				res = res
						&& (this.b == null && this.b == that.b || this.b != null
	...
	/*
	 * 10^10 > Integer.MAX_VALUE = 2147483647 > 10^9 10^19 > Long.MAX_VALUE =
	 * 9223372036854775807L > 10^18
	 */
	public static void main(String[] args) {
		long S = System.currentTimeMillis();

		Scanner sc = new Scanner(System.in);
		new D_hhelibex().solve(sc);
		_out.flush();
